#!/usr/bin/env python3
"""
Post-Extension Pre-2008 Shock Sweep

Sweeps mortgage shocks from -1% to -30% to identify critical thresholds
with FIXED fire sale settings (0.05 intensity, no compounding).
...
def main():
    parser = argparse.ArgumentParser(description="Post-Extension Pre-2008 Shock Sweep")
    ...
    print("=" * 80)
    print("POST-EXTENSION PRE-2008: SHOCK SWEEP")
    print("=" * 80)
    ...
    # Save summary
    summary = {
        'experiment': 'post_extension_pre_2008_shock_sweep',
        'description': 'Post-extension pre-2008 with fixed fire sales',
